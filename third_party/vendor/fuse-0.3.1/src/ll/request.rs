    ...
    fn parse(opcode: &fuse_opcode, data: &mut ArgumentIterator<'a>) -> Option<Self> {
        unsafe {
            Some(match opcode {
                ...
                fuse_opcode::FUSE_IOCTL => Operation::Access { arg: data.fetch()? },
                fuse_opcode::FUSE_POLL => Operation::Access { arg: data.fetch()? },
                fuse_opcode::FUSE_FALLOCATE => Operation::Access { arg: data.fetch()? },
                fuse_opcode::FUSE_INIT => Operation::Access { arg: data.fetch()? },
                fuse_opcode::FUSE_BATCH_FORGET => Operation::Access { arg: data.fetch()? },
                fuse_opcode::CUSE_INIT => Operation::Access { arg: data.fetch()? },
                fuse_opcode::FUSE_NOTIFY_REPLY => Operation::Access { arg: data.fetch()? },
